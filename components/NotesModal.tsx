...
export const NotesModal: React.FC<NotesModalProps> = ({ isOpen, notes, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end justify-end p-4 pointer-events-none">
      <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-lg shadow-[0_20px_50px_rgba(0,0,0,0.5)] w-full max-w-md pointer-events-auto transform animate-slide-up">
        ...
        <div className="text-zinc-400 text-sm leading-relaxed max-h-48 overflow-y-auto italic font-light">
