...
export const slide08: Slide = {
  ...
  list: [
    ...
    'Ispirazione: La sella della bicicletta da corsa.'
  ],
  notes: 'Sella risolve una funzione specifica: la "stazione eretta appoggiata". L\'utente non si siede, ma si appoggia per mantenere la prontezza d\'azione.'
};
