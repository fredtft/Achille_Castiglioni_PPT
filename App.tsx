...
const App: React.FC = () => {
  ...
  return (
    <>
      <div 
        className="relative h-[100dvh] w-screen bg-black overflow-hidden flex flex-col no-print"
        ...
        {isPrintModalOpen && (
          <div className="fixed inset-0 z-[100] flex flex-col bg-zinc-950 no-print overflow-hidden animate-slide-up">
            ...
            <footer className="p-4 bg-zinc-900 border-t border-zinc-800 text-center text-zinc-500 text-[10px] uppercase tracking-widest font-bold">
              Seleziona "Salva come PDF" e orientamento "Orizzontale" (Landscape) e "Margini: Nessuno".
            </footer>
          </div>
        )}
      ...
      {/* Hidden container strictly for actual print engine - outside of main div flow */}
