...
export const slide22: Slide = {
  id: '22',
  type: SlideType.CONTENT_SPLIT,
  title: 'RR126',
  subtitle: 'radiofonografo RR126 (con Pier Giacomo Castiglioni)',
  ...
  notes: 'L\'RR126 è celebre per il suo aspetto che ricorda un volto. È un oggetto che comunica emozione oltre alla funzione tecnica del suono.'
};
