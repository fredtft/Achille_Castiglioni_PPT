...
export const slide06: Slide = {
  ...
  list: [
    ...
    'Componenti: Sedile, balestra d\'acciaio, base in faggio.'
  ],
  notes: 'Il Mezzadro è un atto di design radicale. Presentato nel 1957 a Villa Olmo, rimase un prototipo per anni perché troppo avanzato per il mercato dell\'epoca.'
};
